import 'dart:ui';
import 'package:CloudSP/UserInfo/ui/Screen/UserInfo.dart';
...
class MainScreen extends StatefulWidget {
  ...
  MainScreen(
      {required this.wifiModel, required this.passw, required this.email});
  @override
...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    ...
    refresh.add(FetchData(Urls.GET_API,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusColor:
                                    const Color.fromRGBO(18, 108, 242, 1),
        ...
        floatingActionButton: ElevatedButton(
          style: ElevatedButton.styleFrom(primary: Color(0xFFea831e)),
          onPressed: () {
            showDialog(
                context: context,
                        ...
                        return MainScreenCard(
                          ...
                          onCardPress: (){
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) {
                                      return  UserInfo(userInfoModel: mainScreenModel,password: widget.passw,);}))
                                .then((value) {
                                  if(value != null && value){
                                    refresh.add(FetchData(Urls.GET_API,
                                        headers: {"username": widget.email, "password": widget.passw},
