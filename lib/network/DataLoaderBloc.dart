...
class DataLoaderBloc extends Bloc<GlobalEvent, GlobalState> {
  ...
  _getRequest(String url, {Map<String, String>? headers,Map<String, dynamic>? queryParameters}) async {
...
//      return null;
  ...
  _putRequest(String url, Map<String ,dynamic> body, {Map<String, String>? headers} ) async {
    print(body.length);
    print('----------------------------------------------------');
